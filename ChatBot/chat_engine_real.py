from embedding_processor_real import EmbeddingProcessor
import unicodedata
...
class ChatEngine:
    ...
    def respond(self, message: str, session_id: int) -> str:
        ...
        # 🔹 Busca semântica real com ChromaDB
    ...
    def format_response(self, results, original_query):
        response = f"🔎 **Resultados RAG para:** _{original_query}_\n\n"
